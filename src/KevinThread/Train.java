...
public class Train {
	...
	public static void train(File dataDir) {
		...
		final File networkFile = new File(dataDir, __Config.NETWORK_FILE);
		final File trainingFile = new File(dataDir, __Config.TRAINING_FILE);
		...
		EncogUtility.trainConsole(network, trainingSet, __Config.TRAINING_MINUTES);
